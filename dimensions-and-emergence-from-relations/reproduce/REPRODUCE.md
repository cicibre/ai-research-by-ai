...
| 3.6 | ρ vs severity | `2026-08-17` rho-severity harness | `2026-08-17-rho-severity-sweep-RAW.log` | ~hour |
...
```
The seals are the point: for any claim, read its `seals/` file first, check its commit predates the data commit, then run the producer.
